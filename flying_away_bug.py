...
# Hardcode some parameters for sake of reproducibility
VIS = True
USE_TERRAIN = True
N_ENVS = args.n_envs
DT = 0.02
SUBSTEPS = 50  # still get flying away Puppers with dt=0.02 and substeps=50. Using dt=0.02/50 and substeps=1 results in same behavior
